...
function SelectTehsil({ }) {

  const states = ["Jalore","Bhinmal","Sayla","Jaswantpura","Raniwara","Sanchor"];
    ...
    <View style={styles.container} >
      <View style={{ height: 50, flexDirection: "row", backgroundColor: "#6C63FF", position: "absolute", top: 0, left: 0, right: 0 }}>
        ...
        <View style={{ flex: 0.9, alignItems: "center", justifyContent: "center" }}>
          <Text style={styles.selectstate}> Select Tehsil </Text>
        </View>
      </View>
